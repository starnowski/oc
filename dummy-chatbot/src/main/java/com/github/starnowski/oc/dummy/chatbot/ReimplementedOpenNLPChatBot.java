 ...
 * @author itsallbinary
 */
public class ReimplementedOpenNLPChatBot {
    ...
    private static DoccatModel trainCategorizerModel() throws FileNotFoundException, IOException {
        ...
        // requirements.
        ObjectStream<String> lineStream = new YamlFileByMainNodesStream(createInputStreamFactory("faq-categorizer.yaml"), StandardCharsets.UTF_8);
    ...
    private static InputStreamFactory createInputStreamFactory(String resource) {
        return new InputStreamFactory() {
            ...
            public InputStream createInputStream() throws IOException {
                ReimplementedOpenNLPChatBot bot = new ReimplementedOpenNLPChatBot();
